...
RSpec.describe BookingScopeQuery do
  ...
  it 'includes venue bookings for the matching tenant' do
    ...
    science_booking = create(:booking, venue: science_venue, user: create(:user, :student, tenant: science_tenant))
    create(:booking, venue: arts_venue, user: create(:user, :student, tenant: arts_tenant))
  ...
  it 'includes equipment bookings for the matching tenant' do
    ...
    booking = create(
      :equipment_booking,
      equipment: equipment,
      user: create(:user, :student, tenant: science_tenant),
      quantity: 1,
